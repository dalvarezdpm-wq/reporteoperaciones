...
/** Mismos campos que Pendientes — un "en proceso" es justo eso: un pendiente que ya se
 * empezó a trabajar, con exactamente los mismos datos, nada más en una etapa intermedia
 * antes de subir de verdad a Previos/Despachos/Revalidadas. */
export const EN_PROCESO_FIELDS = PENDIENTE_FIELDS;
