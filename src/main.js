      ...
      if (entry.data === null) {
        ...
        for (const captura of capturas) {
          ...
          try {
            ...
            paraGuardar = fusionarConServidor(fresca, captura);
          } catch (e) {}
 ...
 * tenían ambas). */
function fusionarConServidor(fresca, local) {
  if (!fresca) return local; // nada en el servidor todavía — la copia local manda completa
